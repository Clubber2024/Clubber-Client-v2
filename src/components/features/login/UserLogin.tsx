  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <p className="text-center font-pretendard font-normal text-[14px] leading-[120%] tracking-normal mt-[25px] mb-[15px]">
        SNS로 간편하게 로그인하고<br />더 많은 서비스를 즐겨보세요!
      </p>
      <form onSubmit={handleFormSubmit}>
        ...
        >
          <div className="flex items-center">
            <img src={'/images/login/kakao.png'} className="w-[20px] h-[20px] mr-[5px]" alt="kakao logo" />
            <img src={'/images/login/Line299.png'} className="h-[30px] ml-[5px] opacity-50" alt="line" />
          </div>
