  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center relative">
        ...
        />
        <div className="absolute top-1/2 left-1/2  -translate-x-1/2 -translate-y-1/2 text-white font-[Pretendard] font-semibold text-[40px] leading-[100%] tracking-[0] mt-[200px] flex justify-center items-center flex-col">
          마이페이지
          <div className="flex flex-col justify-center items-center mt-[70px]">
            <img
              src={'/images/admin/admin-profile-img.png'}
              alt="profile"
              className="w-[135px] h-[135px]  z-10 absolute top-20"
            />
