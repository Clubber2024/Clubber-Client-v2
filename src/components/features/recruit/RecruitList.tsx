            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-20">
              {recruitList.map((item) => (
                ...
                >
                  ...
                  >
                    {item.imageUrl && (
                      <img src={item.imageUrl} className="w-[130px] sm:w-fit sm:min-w-[160px] aspect-square mr-2" />
                    )}
                    <div className="min-w-0 flex flex-col my-1 w-full mx-1">
                      ...
                      <p className="cursor-pointer text-[16px] leading-[120%] tracking-[0] text-[#888888] line-clamp-4 break-all w-full max-w-full flex-1 overflow-hidden">
                        {item.content}
                      </p>
                    </div>
                  </div>
